...
def purchase_torpedo(
    ...
    *,
    ...
    """Pay material, own, and select a stronger production Torpedo."""
    ...
    if material_before < target.price:
        raise FishCommandError(
            "insufficient material for torpedo purchase: "
