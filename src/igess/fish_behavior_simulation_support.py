...
_COMPACT_EVENT_DETAIL_KEYS = frozenset(
    {
        ...
        "barbell_id",
        "barbell_synthesis_price",
        "barbell_synthesis_price_resource",
        ...
        "fish_roll_power",
        "fish_upgrade_price",
        "fish_upgrade_price_resource",
        "fish_upgrade_hall_income_delta",
        "fish_hall_income_per_second_before_upgrade",
        "fish_hall_income_per_second_after_upgrade",
        "fish_weight_gram",
        "input_strength",
